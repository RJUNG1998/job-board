    ...
    <header className="py-10 border-b border-white/5 flex items-end justify-between gap-6 flex-wrap">
      ...
      <div className="flex items-center gap-3">
        ...
        {user ? (
          ...
          <button
            onClick={handleLogin}
            className="flex items-center gap-2 bg-white/[0.03] border border-white/[0.06] hover:bg-white/[0.06] hover:border-white/10 rounded-xl px-4 py-3 transition-colors"
          >
